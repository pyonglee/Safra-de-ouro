...
let ReportsService = ReportsService_1 = class ReportsService {
    ...
    async getExpenseReport(userId, filters) {
        const where = { userId };
    ...
    async getWorkerReport(userId, harvestId) {
        const where = { userId };
        if (harvestId)
    ...
    async getProductionReport(userId, harvestId) {
        const where = { userId };
        if (harvestId)
            where.id = harvestId;
    ...
    async getProfitReport(userId, harvestId) {
        let harvestName = null;
